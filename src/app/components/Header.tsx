  ...
  return (
    <>
      ...
      <Navbar className="border-b-2">
        ...
        >
          <span className="px-2 py-1 bg-gradient-to-r from-purple-600 via-yellow-300 to-orange-500 hover:from-orange-500 hover:via-yellow-300 hover:to-purple-600 rounded-lg text-white transition-all duration-500">
