...
3. Now create the route to get the comments: `/src/app/api/comments/getPostComments/[postId]/route.ts`
   ...
   */
   ...
   ```
4. PUT Like/Unlike Comment `/src/app/api/comments/likeComment/[commentId]/route.ts`:
   ```
...
export async function PUT(req: NextRequest) {
  ...
  try {
   ...
   ```
5. PUT Edit Comment - `/src/app/api/comments/editComment/[commentId]/route.ts`:
```
...
```
6. Delete comment create file: `/src/app/api/comments/deleteComment/[commentId]/route.ts`:
```
   import { NextRequest, NextResponse } from "next/server";
   import { connect } from "@/lib/mongodb/mongoose";
   import Comment from "@/lib/models/comment.model";
...
```
7. Utility Fetch Functions - `/src/lib/actions/comments.ts` add the code:
   ```
...
8. Using in a Component `/src/components/CommentSection.tsx`:
   ```
